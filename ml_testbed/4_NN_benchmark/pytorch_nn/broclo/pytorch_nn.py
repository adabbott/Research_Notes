...
datasets = ["int_PES.dat"]#../../datasets/h2o","../../datasets/h3o", "../../datasets/h2co", "../../datasets/ochco"]
...
def build_model(path):
    ...
    factor = (yscaler.data_max_[0] - yscaler.data_min_[0]) / (yscaler.feature_range[1] - yscaler.feature_range[0])
    ...
    for l in layers:
        ...
        optimizer = torch.optim.LBFGS(model.parameters(), tolerance_grad=1e-7, tolerance_change=1e-12, lr=0.5)
